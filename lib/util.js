...
exports.watcher = {
  rollup (config) {
    const rollupConfig = [
      getRollupConfig(config, false, 'umd'),
      getRollupConfig(config, true, 'umd'),
      ...(config.bundleOnly ? [
        getRollupConfig(config, false, 'cjs'),
        getRollupConfig(config, true, 'cjs'),
        getRollupConfig(config, false, 'esm'),
        getRollupConfig(config, true, 'esm'),
      ] : [])
    ]
  ...
  webpack (config) {
    const webpackConfig = [
      getWebpackConfig(config, false, 'umd'),
      getWebpackConfig(config, true, 'umd'),
      ...(config.bundleOnly ? [
        getWebpackConfig(config, false, 'cjs'),
        getWebpackConfig(config, true, 'cjs'),
        getWebpackConfig(config, false, 'esm'),
        getWebpackConfig(config, true, 'esm'),
      ] : [])
    ]

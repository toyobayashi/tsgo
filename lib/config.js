...
function readConfigNoCache (configFile) {
  ...
  if (typeof mergedConfig.library === 'function') {
    mergedConfig.library = mergedConfig.library(mergedConfig.output.name) || camelCase(mergedConfig.output.name)
  }
